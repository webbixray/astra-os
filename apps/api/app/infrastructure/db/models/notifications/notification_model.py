...
class NotificationModel(Base):
    ...
    __table_args__ = (Index("idx_notifications_user_org_channel_read_archived", "user_id", "organization_id", "channel", "archived", "is_read"),)
    ...
    def to_domain(self) -> Notification:
        return Notification(
            ...
            channel=self.channel, template_id=self.template_id,
            is_read=self.is_read, read_at=self.read_at.replace(tzinfo=None) if self.read_at else None,
    ...
    def from_domain(cls, notification: Notification) -> "NotificationModel":
        return cls(
            id=notification.id, organization_id=notification.organization_id, user_id=notification.user_id,
            type=notification.type, title=notification.title, body=notification.body,
            resource_type=notification.resource_type, resource_id=notification.resource_id,
            channel=notification.channel, template_id=notification.template_id,
