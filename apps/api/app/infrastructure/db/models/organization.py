...
class OrganizationModel(Base):
    ...
    parent_org_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True, index=True)
    ...
    def to_domain(self) -> Organization:
        return Organization(
            ...
            plan_tier=self.plan_tier, parent_org_id=self.parent_org_id,
    ...
    def from_domain(cls, org: Organization) -> "OrganizationModel":
        return cls(
            ...
            plan_tier=org.plan_tier, parent_org_id=org.parent_org_id,
