...
def _campaign_launch_template() -> WorkflowTemplate:
    ...
    return WorkflowTemplate(
        ...
        nodes=[
            WorkflowNode.create(
                "t1", NodeType.TRIGGER, "Campaign Created", position_x=250, position_y=0
            ),
            WorkflowNode.create(
                "a1",
                NodeType.ACTION,
            ...
            WorkflowNode.create(
                "d1", NodeType.DELAY, "Wait 24h", {"seconds": 86400}, position_x=250, position_y=320
            ),
            WorkflowNode.create(
                "a3",
                NodeType.ACTION,
            ...
            WorkflowNode.create("e1", NodeType.END, "Complete", position_x=250, position_y=480),
        ],
        edges=[
...
def _creative_review_template() -> WorkflowTemplate:
    ...
    return WorkflowTemplate(
        ...
        nodes=[
            WorkflowNode.create(
                "t1", NodeType.TRIGGER, "Review Requested", position_x=250, position_y=0
            ),
            WorkflowNode.create(
                "a1",
                NodeType.ACTION,
            ...
            WorkflowNode.create("e1", NodeType.END, "Complete", position_x=250, position_y=400),
        ],
        edges=[
            WorkflowEdge.create("e1", "t1", "a1"),
...
def _optimization_loop_template() -> WorkflowTemplate:
    ...
    return WorkflowTemplate(
        ...
        nodes=[
            ...
            WorkflowNode.create(
                "e1", NodeType.END, "Cycle Complete", position_x=250, position_y=480
            ),
        ],
        edges=[
            WorkflowEdge.create("e1", "t1", "a1"),
...
def _brand_compliance_template() -> WorkflowTemplate:
    ...
    return WorkflowTemplate(
        ...
        nodes=[
            WorkflowNode.create(
                "t1", NodeType.TRIGGER, "Content Submitted", position_x=250, position_y=0
            ),
            WorkflowNode.create(
                "a1",
                NodeType.ACTION,
