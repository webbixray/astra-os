...
class DeliverReportRequest(BaseModel):
    report_type: str = "overview"
    channel: str = "email"
    recipient: str = Field(default="", min_length=5, max_length=320)
    format: str = "csv"
...
@router.get("/reports/templates", summary="List report templates")
...
@router.put("/reports/templates/{template_id}", summary="Update report template")
...
@router.get("/reports/delivery-logs", summary="Get delivery logs")
