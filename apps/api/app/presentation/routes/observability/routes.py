...
from app.domain.entities.campaigns import Campaign, CampaignStatus
from app.domain.entities.advertising import AdAccount, AdPlatform
from app.infrastructure.db.session import get_db
from app.infrastructure.cache.redis import get_redis
from app.presentation.middleware.auth import require_user_id
from app.presentation.middleware.tenant import require_organization_id
...
from app.infrastructure.db.repositories.advertising.ad_account_repository import AdAccountRepositoryImpl
...
async def _get_spend_stats(
    ...
    cutoff = now() - timedelta(days=days)
    ad_account_repo = AdAccountRepositoryImpl(db)
