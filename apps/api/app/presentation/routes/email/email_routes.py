...
@router.get("/email/campaigns", summary="List email campaigns")
...
@router.post("/email/campaigns/{campaign_id}/send", summary="Send email campaign")
...
@router.post("/email/campaigns/{campaign_id}/events", summary="Record email event")
