...
from app.presentation.routes.telegram import router as telegram_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(sync_router, prefix="/api/v1/campaigns", tags=["campaign-sync"])
    # gen_routes must come BEFORE content_routes to avoid route hijacking
    # (content_routes has /{content_id} catch-all that intercepts /templates, /ai/* etc.)
    ...
    app.include_router(observability_router, prefix="/api/v1/observability", tags=["observability-tenant"])
