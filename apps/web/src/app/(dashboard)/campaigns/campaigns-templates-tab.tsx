...
import { Plus, LayoutTemplate, Copy, Loader2 } from 'lucide-react';
...
interface CampaignsTemplatesTabProps {
  orgId: string;
}

export function CampaignsTemplatesTab({ orgId }: CampaignsTemplatesTabProps) {
