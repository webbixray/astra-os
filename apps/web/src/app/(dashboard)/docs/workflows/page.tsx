...
const WORKFLOW_SECTIONS = [
  {
    ...
    description: 'Understand how workflow automation works in Astra OS',
  ...
  },
  {
    ...
    description: 'Build workflows with drag-and-drop visual editor',
  ...
  },
  {
    ...
    icon: <Zap className="h-5 w-5" />,
    href: '/docs/workflows/triggers-actions',
    category: 'guides',
  },
  {
    id: 'scheduling',
    title: 'Scheduling & Recurrence',
    description: 'Set up recurring workflows and cron-like schedules',
  ...
  },
  {
    ...
    description: 'Test and debug workflows before deploying',
  ...
  },
  {
    ...
    description: 'Monitor workflow executions and troubleshoot issues',
    icon: <BarChart className="h-5 w-5" />,
    href: '/docs/workflows/monitoring',
    category: 'guides',
  },
];
...
export default function WorkflowsPage() {
  ...
  const filteredSections = WORKFLOW_SECTIONS.filter((section) => {
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Build powerful automated marketing workflows with visual drag-and-drop builder.
            </p>
          </div>
