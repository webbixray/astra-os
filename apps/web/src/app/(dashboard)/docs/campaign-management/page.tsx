...
const CAMPAIGN_SECTIONS = [
  {
    ...
    description: 'Understand the campaign lifecycle and management features',
    icon: <Zap className="h-5 w-5" />,
    href: '/docs/campaign-management/overview',
    category: 'guides',
  },
  {
    id: 'creating-campaigns',
    title: 'Creating Campaigns',
    description: 'Step-by-step guide to creating effective campaigns',
    icon: <Zap className="h-5 w-5" />,
    href: '/docs/campaign-management/creating-campaigns',
    category: 'guides',
  },
  {
    id: 'budget-pacing',
    title: 'Budget Pacing & Optimization',
    description: 'Control spend with smart budget pacing strategies',
    icon: <DollarSign className="h-5 w-5" />,
    href: '/docs/campaign-management/budget-pacing',
    category: 'guides',
  },
  {
    id: 'targeting',
    title: 'Audience Targeting',
    description: 'Define and refine your target audiences',
    icon: <Users className="h-5 w-5" />,
    href: '/docs/campaign-management/targeting',
    category: 'guides',
  },
  {
    id: 'creatives',
    title: 'Creative Management',
    description: 'Upload, test, and optimize ad creatives',
    icon: <Image className="h-5 w-5" />,
    href: '/docs/campaign-management/creatives',
    category: 'guides',
  },
  {
    id: 'a-b-testing',
    title: 'A/B Testing',
    description: 'Run experiments to optimize campaign performance',
    icon: <FlaskConical className="h-5 w-5" />,
    href: '/docs/campaign-management/ab-testing',
    category: 'guides',
  },
  {
    id: 'launch-pause',
    title: 'Launching & Pausing Campaigns',
    description: 'Control campaign lifecycle with confidence',
    icon: <Play className="h-5 w-5" />,
    href: '/docs/campaign-management/launch-pause',
    category: 'guides',
  },
  {
    id: 'reporting',
    ...
    href: '/docs/campaign-management/reporting',
    category: 'guides',
  },
];
...
export default function CampaignManagementPage() {
  ...
  const filteredSections = CAMPAIGN_SECTIONS.filter((section) => {
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Learn how to create, launch, and optimize marketing campaigns with Astra OS.
            </p>
          </div>
