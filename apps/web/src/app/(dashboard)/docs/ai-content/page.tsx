...
const AI_CONTENT_SECTIONS = [
  {
    ...
    description: 'Understand how AI content generation works in Astra OS',
    icon: <Zap className="h-5 w-5" />,
    href: '/docs/ai-content/overview',
    category: 'guides',
  },
  {
    id: 'brand-voice',
    ...
    href: '/docs/ai-content/brand-voice',
    category: 'guides',
  },
  {
    id: 'templates',
    ...
    href: '/docs/ai-content/templates',
    category: 'guides',
  },
  {
    id: 'seo-optimization',
    ...
    href: '/docs/ai-content/seo-optimization',
    category: 'guides',
  },
  {
    id: 'social-posts',
    ...
    href: '/docs/ai-content/social-posts',
    category: 'guides',
  },
  {
    id: 'email-campaigns',
    title: 'Email Campaigns',
    description: 'Generate email sequences and newsletters',
    icon: <Mail className="h-5 w-5" />,
    href: '/docs/ai-content/email-campaigns',
    category: 'guides',
  },
  {
    id: 'blog-articles',
    ...
    icon: <FileText className="h-5 w-5" />,
    href: '/docs/ai-content/blog-articles',
    category: 'guides',
  },
  {
    id: 'ad-copy',
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Generate high-quality marketing content with AI across all channels.
            </p>
          </div>
