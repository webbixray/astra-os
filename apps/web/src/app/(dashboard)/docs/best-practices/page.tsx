...
const BEST_PRACTICES_SECTIONS = [
  {
    ...
    description: 'Organize campaigns for maximum performance and scalability',
    icon: <Layers className="h-5 w-5" />,
    href: '/docs/best-practices/campaign-structure',
    category: 'guides',
  },
  {
    id: 'audience-targeting',
    title: 'Audience Targeting Strategies',
    description: 'Advanced targeting techniques for better ROI',
    icon: <Target className="h-5 w-5" />,
    href: '/docs/best-practices/audience-targeting',
    category: 'guides',
  },
  {
    id: 'creative-testing',
    title: 'Creative Testing Framework',
    description: 'Systematic approach to creative testing and optimization',
    icon: <FlaskConical className="h-5 w-5" />,
    href: '/docs/best-practices/creative-testing',
    category: 'guides',
  },
  {
    id: 'budget-allocation',
    title: 'Budget Allocation Strategies',
    description: 'Optimize budget distribution across campaigns and channels',
    icon: <DollarSign className="h-5 w-5" />,
    href: '/docs/best-practices/budget-allocation',
    category: 'guides',
  },
  {
    id: 'ai-prompting',
    title: 'AI Prompting Best Practices',
    description: 'Write effective prompts for AI content generation',
    icon: <Brain className="h-5 w-5" />,
    href: '/docs/best-practices/ai-prompting',
    category: 'guides',
  },
  {
    id: 'workflow-automation',
    title: 'Workflow Automation Patterns',
    description: 'Common automation patterns for marketing teams',
    icon: <Zap className="h-5 w-5" />,
    href: '/docs/best-practices/workflow-automation',
    category: 'guides',
  },
  {
    id: 'data-hygiene',
    title: 'Data Hygiene & Governance',
    description: 'Maintain clean data for better decisions',
    icon: <Shield className="h-5 w-5" />,
    href: '/docs/best-practices/data-hygiene',
    category: 'guides',
  },
  {
    id: 'team-collaboration',
    title: 'Team Collaboration Workflows',
    description: 'Effective collaboration patterns for marketing teams',
    icon: <Users className="h-5 w-5" />,
    href: '/docs/best-practices/team-collaboration',
    category: 'guides',
  },
  {
    id: 'compliance',
    title: 'Compliance & Privacy',
    description: 'Stay compliant with GDPR, CCPA, and platform policies',
    icon: <Shield className="h-5 w-5" />,
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Proven strategies and patterns for getting the most out of Astra OS.
            </p>
          </div>
