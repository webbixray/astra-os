...
import { BarChart, BookOpen, ChevronRight, Code, ExternalLink, Heart, MessageSquare, Reply, Shield, Zap } from 'lucide-react';
...
const SOCIAL_SECTIONS = [
  {
    ...
    description: 'Monitor, analyze, and auto-reply to social media interactions',
    icon: <MessageSquare className="h-5 w-5" />,
    href: '/docs/social-intelligence/overview',
    category: 'guides',
  },
  {
    id: 'comment-monitoring',
    title: 'Comment Monitoring',
    description: 'Track comments across Meta, LinkedIn, and other platforms',
    icon: <MessageSquare className="h-5 w-5" />,
    href: '/docs/social-intelligence/comment-monitoring',
    category: 'guides',
  },
  {
    id: 'auto-reply',
    title: 'AI Auto-Reply',
    description: 'Configure AI-powered automatic replies to comments',
    icon: <Reply className="h-5 w-5" />,
    href: '/docs/social-intelligence/auto-reply',
    category: 'guides',
  },
  {
    id: 'sentiment-analysis',
    title: 'Sentiment Analysis',
    description: 'Analyze sentiment trends across your social channels',
    icon: <Heart className="h-5 w-5" />,
    href: '/docs/social-intelligence/sentiment-analysis',
    category: 'guides',
  },
  {
    id: 'moderation',
    title: 'Content Moderation',
    description: 'Automatically filter spam, toxicity, and inappropriate content',
    icon: <Shield className="h-5 w-5" />,
    href: '/docs/social-intelligence/moderation',
    category: 'guides',
  },
  {
    id: 'engagement-analytics',
    title: 'Engagement Analytics',
    description: 'Track engagement metrics across all social channels',
    icon: <BarChart className="h-5 w-5" />,
    href: '/docs/social-intelligence/engagement-analytics',
    category: 'guides',
  },
];
...
export default function SocialIntelligencePage() {
  ...
  const filteredSections = SOCIAL_SECTIONS.filter((section) => {
  ...
  const groupedSections = filteredSections.reduce((acc, section) => {
    ...
    return acc;
  }, {} as Record<string, typeof SOCIAL_SECTIONS>);
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Monitor, analyze, and auto-reply to social media interactions across all platforms.
            </p>
          </div>
