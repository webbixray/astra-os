...
const TROUBLESHOOTING_SECTIONS = [
  {
    ...
    description: 'Resolve login, token, and permission problems',
    icon: <Lock className="h-5 w-5" />,
    href: '/docs/troubleshooting/auth-issues',
    category: 'guides',
  },
  {
    id: 'api-errors',
    title: 'API Error Codes',
    description: 'Understand and resolve common API error responses',
  ...
  },
  {
    ...
    description: 'Fix campaigns not delivering or spending',
    icon: <AlertTriangle className="h-5 w-5" />,
    href: '/docs/troubleshooting/campaign-delivery',
    category: 'guides',
  },
  {
    id: 'sync-issues',
    title: 'Data Sync Problems',
    description: 'Resolve data synchronization between platforms',
    icon: <RefreshCw className="h-5 w-5" />,
    href: '/docs/troubleshooting/sync-issues',
    category: 'guides',
  },
  {
    id: 'performance',
    title: 'Performance Optimization',
    description: 'Diagnose and fix slow queries and timeouts',
  ...
  },
  {
    ...
    description: 'Debug webhook delivery and retry issues',
  ...
  },
  {
    ...
    description: 'Resolve billing, subscription, and payment problems',
    icon: <CreditCard className="h-5 w-5" />,
    href: '/docs/troubleshooting/billing',
    category: 'guides',
  },
  {
    id: 'integration',
    title: 'Integration Connection Issues',
    description: 'Fix Meta, Google, LinkedIn connection problems',
    icon: <Link2 className="h-5 w-5" />,
    href: '/docs/troubleshooting/integration',
    category: 'guides',
  },
];
...
export default function TroubleshootingPage() {
  ...
  const filteredSections = TROUBLESHOOTING_SECTIONS.filter((section) => {
        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground text-lg">
              Common issues and solutions for Astra OS.
            </p>
          </div>
